                ...
                {user ? (
                  <div className="flex flex-col gap-2 pt-2 border-t border-gray-800">
                    ...
                    <Link
                      href="/profile"
                      onClick={() => setMenuOpen(false)}
                      className="text-sm text-gray-300 hover:text-white transition py-1"
                    >
                      My Profile
                    </Link>
                    <Link
                  ...
                  <div className="flex gap-3 pt-2 border-t border-gray-800">
                    <Link
                      href="/auth/login"
                      onClick={() => setMenuOpen(false)}
                      className="flex-1 text-center text-sm border border-gray-600 hover:border-white text-gray-300 hover:text-white py-2 rounded-lg transition"
                    >
                      Sign In
                    </Link>
                    <Link
                      href="/auth/signup"
                      onClick={() => setMenuOpen(false)}
                      className="flex-1 text-center text-sm bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg transition"
                    >
                      Sign Up
                    </Link>
                  </div>
